...
def test_nested_data_model():
    ...
    assert (
        generate_create_table_query(ModelTest)
        == "CREATE TABLE ModelTest (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, nested INTEGER, FOREIGN KEY (nested) REFERENCES NestedDataModel(id))"
    )
...
def test_nested_data_model_string_id():
    ...
    assert (
        generate_create_table_query(ModelTest)
        == "CREATE TABLE ModelTest (id TEXT PRIMARY KEY, name TEXT NOT NULL, nested TEXT, FOREIGN KEY (nested) REFERENCES NestedDataModel(id))"
    )
...
def test_ignore_if_exists():
    ...
    assert (
        generate_create_table_query(ModelTest, ignore_if_exists=True)
        == "CREATE TABLE IF NOT EXISTS ModelTest (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL)"
    )
